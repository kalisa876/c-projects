//CS 244 MIDTRM PART 1 GROUP #
//MEMBERS: Chris Edosomwan ,Kalisa Mckenzie ,Cortney McMillan, Sami Obadi
//Due October 25!!!
...
void trip_length(int &total_days) // Function used to get the length of trip (KALISA)
{
  total_days = 0;
...
void trip_time(int & first_day, int & last_day, string &section_time1, string &section_time2)// Function used to get the arrival and departure times (CHRIS)
{ 
...
void trip_airfare(double &round_trip_airfare) // Function that calls the price of airfare (KALISA)
{
...
void miles_driven(double &miles_cost, double &car_rentals) // Function that gets the total miles driven (KALISA)
{
  int miles; 
...
void parking(int total_days, double &cost_of_parking, double &excess_parking, double &parking_reimburse) // Function that gets parking fees (CHRIS)
{ 
...
void taxi_fees(double &cost_of_taxi, double &extra_taxi_fees, int total_days)//Function that gets taxi fees (CORTNEY)
{ 
  int num_days;
...
void reg_fees( double &registration_fees) //Function that calculates the registration fees (KALISA)
{
  string response;
...
void hotel(int total_days, double &hotel_total, double &hotel_cost, double &hotel_reimburse) //Function that gets hotel prices (CHRIS)
{ 
...
void display(int total_days, double cost_of_taxi, double extra_taxi_fees, int first_day, string section_time1, int last_day, string section_time2, double round_trip_airfare, double car_rentals, double miles_cost, double cost_of_parking, double parking_reimburse, double hotel_total, double hotel_cost, double hotel_reimburse, double registration_fees)//KALISA
{
