...
public:
  ...
  ~Circles();
  Circles(float rad, int x,
          int y);   // Constructor so that the user can enter radius
...
int main() {
  ...
  Circles sphere3(1, 15, 16); // object for sphere 3
  ...
  cout << "The circumference of the circle is " << sphere3.findCircumference()
       << endl;
  return 0;
}
...
Circles::~Circles() { cout << "This concludes the circle class" << endl; }
